function [metrics, scaled,unscaled] = synthLoadMultipleStates(base_dir, generations)
%function data_per_gen = synthLoadMultipleStates(base_dir, generations)
%
% @description
%  
...
%
    ...
    for generation = generations
        ...
        cmd=['./summarize_db.py ' base_dir '/' state_file ' None temp_metrics temp_points'];
        system(cmd);
