...
from problems.Library import replaceAfterMRWithBlank, replaceSummaryStrWithBlank
...
"""
    ...
    def testMos4(self):
        ...
        target_str0 = """M0 1 2 3 4 Nnom M=1 L=9e-07 W=5.4e-07
"""
        ...
        target_str1 = """M0 1 2 3 4 Pnom M=1 L=9e-07 W=1.08e-06
"""
    ...
    def testMos3_asNmos(self):
        ...
        target_str = """M0 1 2 3 3 Nnom M=1 L=9e-07 W=5.4e-07
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings(target_str, actual_str)
        ...
        target_str = """M0 1 2 3 3 Nnom M=4 L=9e-07 W=4.5e-06
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings(target_str, actual_str)
    ...
    def testMos3_asPmos(self):
        ...
        target_str = """M0 1 2 3 3 Pnom M=1 L=9e-07 W=1.08e-06
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings(target_str, actual_str)
        ...
        target_str = """M0 1 2 3 3 Pnom M=8 L=9e-07 W=4.5e-06
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings(target_str, actual_str)
    ...
    def testSaturatedMos3(self):
        ...
        self.assertEqual( part.numSubpartPermutations(), 2)
        self.assertEqual(len(part.simulation_DOCs), 2)
        ...
        sat_doc = part.simulation_DOCs[1]
        self.assertEqual(sat_doc.metric.name, 'sat_violation')
        self.assertTrue(sat_doc.metric.min_threshold < sat_doc.metric.max_threshold)
        self.assertEqual(sat_doc.function_str, 'sat_violation')
...
"""
    ...
    def testMosDiode(self):
        ...
        target_str = """M0 1 1 2 2 Pnom M=1 L=9e-07 W=1.08e-06
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings(target_str, actual_str)
...
"""
    ...
    def testBiasedMos(self):
        ...
        target_str = """M0 1 n_auto_2 2 2 Pnom M=1 L=9e-07 W=1.08e-06
...
"""
    ...
    def testBiasedMosOrWire(self):
        ...
        target_str = """M0 a n_auto_2 b b Pnom M=1 L=9e-07 W=5.4e-07
V1 n_auto_2 0  DC 0.39
"""
        actual_str = instance.spiceNetlistStr()
...
"""
    ...
    def testTwoBiasedMoses(self):
        ...
        target_str = """M0 1 n_auto_162 n_auto_161 n_auto_161 Nnom M=1 L=5.4e-07 W=5.4e-07
V1 n_auto_162 0  DC 1.5
M2 n_auto_161 n_auto_163 2 2 Nnom M=1 L=9e-07 W=9e-07
...
"""
    ...
    def testStackedCascodeMos__nmos(self):
        ...
        target_str = """M0 1 n_auto_161 2 2 Nnom M=1 L=9e-07 W=9e-07
...
"""
        ...
        target_str = """M0 1 n_auto_163 n_auto_162 n_auto_162 Nnom M=1 L=5.4e-07 W=5.4e-07
V1 n_auto_163 0  DC 1.5
M2 n_auto_162 n_auto_164 2 2 Nnom M=1 L=9e-07 W=9e-07
...
"""
        ...
        target_str = """M0 1 n_auto_403 n_auto_402 n_auto_402 Pnom M=1 L=5.4e-07 W=1.08e-06
V1 n_auto_403 0  DC 0.3
M2 n_auto_402 n_auto_404 2 2 Pnom M=1 L=9e-07 W=1.8e-06
...
"""
    ...
    def testLevelShifter__nmos(self):
        ...
        target_str = """M0 Vdd Vin Iout Iout Nnom M=1 L=5.4e-07 W=5.4e-07
M1 Iout n_auto_117 gnd gnd Nnom M=1 L=9e-07 W=9e-07
...
"""
    ...
    def testLevelShifter__pmos(self):
        ...
        target_str = """M0 gnd Vin Iout Iout Pnom M=1 L=5.4e-07 W=1.08e-06
M1 Iout n_auto_6 Vdd Vdd Pnom M=1 L=9e-07 W=1.8e-06
...
"""
        ...
        target_str = """M0 gnd Vin Iout Iout Pnom M=1 L=5.4e-07 W=1.08e-06
M1 Iout n_auto_7 Vdd Vdd Pnom M=1 L=9e-07 W=1.8e-06
...
"""
    ...
    def testCascodeDevice(self):
        ...
        point = {'chosen_part_index':0,
                 ...
                 'Vbias':1.41}
        instance = EmbeddedPart(part, conns, point)
        target_str = """M0 1 n_auto_2 2 2 Nnom M=1 L=9e-07 W=5.4e-07
...
"""
        ...
        instance = EmbeddedPart(part, conns, point)
        target_str = """M0 1 n_auto_2 2 2 Pnom M=1 L=9e-07 W=5.4e-07
V1 n_auto_2 0  DC 0.39
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings3(target_str, actual_str)
...
"""
    ...
    def testCascodeDeviceOrWire(self):
        ...
        target_str0 = """M0 1 n_auto_2 2 2 Nnom M=1 L=9e-07 W=5.4e-07
V1 n_auto_2 0  DC 1.41
"""
        actual_str0 = instance0.spiceNetlistStr()
...
"""
    ...
    def _stackedNetlist(self, input_is_pmos):
        ...
        if input_is_pmos:
            ...
            return """M0 Iout n_auto_199 n_auto_197 n_auto_197 Pnom M=1 L=7.2e-07 W=1.08e-06
V1 n_auto_199 0  DC 0.1
M2 n_auto_197 Vin n_auto_198 n_auto_198 Pnom M=1 L=1.08e-06 W=1.8e-06
R3 n_auto_198 Vdd  R=1.03e+06
"""
        else:
            #all transistors should be nmos
            return """M0 Iout n_auto_15 n_auto_13 n_auto_13 Nnom M=1 L=7.2e-07 W=5.4e-07
V1 n_auto_15 0  DC 1.7
M2 n_auto_13 Vin n_auto_14 n_auto_14 Nnom M=1 L=1.08e-06 W=9e-07
...
"""
    ...
    def _foldedNetlist(self, input_is_pmos):
        """For testing testInputCascode_Folded"""
        if input_is_pmos:
            return """M0 Iout n_auto_203 n_auto_202 n_auto_202 Nnom M=1 L=7.2e-07 W=5.4e-07
V1 n_auto_203 0  DC 1.7
M2 n_auto_202 Vin n_auto_201 n_auto_201 Pnom M=1 L=1.08e-06 W=1.8e-06
R3 n_auto_201 Vdd  R=1.03e+06
M4 n_auto_202 n_auto_204 gnd gnd Nnom M=1 L=1.62e-06 W=1.62e-06
V5 n_auto_204 0  DC 1.74
"""
        else:
            return """M0 Iout n_auto_11 n_auto_10 n_auto_10 Pnom M=1 L=7.2e-07 W=5.4e-07
V1 n_auto_11 0  DC 0.1
M2 n_auto_10 Vin n_auto_9 n_auto_9 Nnom M=1 L=1.08e-06 W=9e-07
R3 n_auto_9 gnd  R=1.03e+06
M4 n_auto_10 n_auto_13 Vdd Vdd Pnom M=1 L=1.62e-06 W=1.62e-06
...
"""
    ...
    def testSsIiLoad_Cascoded(self):
        ...
        target_str = """M0 n_auto_83 n_auto_84 Vdd Vdd Pnom M=1 L=7.2e-07 W=5.4e-07
V1 n_auto_84 0  DC 0.39
M2 Iout n_auto_85 n_auto_83 n_auto_83 Pnom M=1 L=1.08e-06 W=9e-07
...
"""
        ...
        target_str = """M0 n_auto_86 n_auto_87 gnd gnd Nnom M=1 L=7.2e-07 W=5.4e-07
V1 n_auto_87 0  DC 1.41
M2 Iout n_auto_88 n_auto_86 n_auto_86 Nnom M=1 L=1.08e-06 W=9e-07
...
M1 n_auto_100 Vin n_auto_101 n_auto_101 Nnom M=1 L=1.08e-06 W=9e-07
...
M0 Iout n_auto_9 n_auto_8 n_auto_8 Pnom M=1 L=7.2e-07 W=1.08e-06
V1 n_auto_9 0  DC 0.1
M2 n_auto_8 Vin n_auto_7 n_auto_7 Nnom M=1 L=1.08e-06 W=9e-07
Rwire3 n_auto_7 gnd  R=0
M4 n_auto_8 n_auto_10 Vdd Vdd Pnom M=1 L=1.62e-06 W=3.24e-06
...
"""
    ...
    def testCurrentMirror_Simple(self):
        ...
        target_str = """M0 Irefnode Irefnode gnd gnd Nnom M=1 L=9e-07 W=1.08e-06
M1 Ioutnode Irefnode gnd gnd Nnom M=1 L=9e-07 W=2.16e-06
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings(target_str, actual_str)
        ...
        target_str = """M0 Irefnode Irefnode Vdd Vdd Pnom M=1 L=9e-07 W=1.08e-06
M1 Ioutnode Irefnode Vdd Vdd Pnom M=1 L=9e-07 W=2.16e-06
"""
        actual_str = instance.spiceNetlistStr()
    ...
    def testCurrentMirror_Cascode(self):
        ...
        target_str = """M0 Irefnode Irefnode n_auto_10 n_auto_10 Nnom M=1 L=9e-07 W=1.08e-06
M1 n_auto_10 n_auto_10 gnd gnd Nnom M=1 L=9e-07 W=1.62e-06
M2 Ioutnode Irefnode n_auto_11 n_auto_11 Nnom M=1 L=9e-07 W=2.16e-06
M3 n_auto_11 n_auto_10 gnd gnd Nnom M=1 L=9e-07 W=3.24e-06
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings3(target_str, actual_str)
    ...
    def testCurrentMirror_LowVoltageA(self):
        ...
        target_str = """M0 Irefnode n_auto_17 n_auto_15 n_auto_15 Nnom M=1 L=9e-07 W=1.08e-06
V1 n_auto_17 0  DC 1.2
M2 n_auto_15 Irefnode gnd gnd Nnom M=1 L=9e-07 W=1.62e-06
M3 Ioutnode n_auto_18 n_auto_16 n_auto_16 Nnom M=1 L=9e-07 W=2.16e-06
V4 n_auto_18 0  DC 1.2
M5 n_auto_16 Irefnode gnd gnd Nnom M=1 L=9e-07 W=3.24e-06
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings3(target_str, actual_str)
    ...
    def testDsIiLoad(self):
        ...
        target_str = """M0 Iin1 Iin1 gnd gnd Nnom M=1 L=9e-07 W=5.4e-07
M1 Iin2 Iin1 gnd gnd Nnom M=1 L=9e-07 W=1.08e-06
...
M1 n_auto_8 Vin1 n_auto_9 n_auto_9 Nnom M=1 L=1.8e-06 W=4e-06
Rwire2 n_auto_9 n_auto_7  R=0
Rwire3 Iout2 n_auto_10  R=0
M4 n_auto_10 Vin2 n_auto_11 n_auto_11 Nnom M=1 L=1.8e-06 W=4e-06
Rwire5 n_auto_11 n_auto_7  R=0
M6 n_auto_7 n_auto_12 gnd gnd Nnom M=1 L=1.8e-06 W=6e-06
...
M1 n_auto_14 Vin1 n_auto_15 n_auto_15 Pnom M=1 L=1.8e-06 W=4e-06
R2 n_auto_15 n_auto_13  R=1.03e+06
Rwire3 Iout2 n_auto_16  R=0
M4 n_auto_16 Vin2 n_auto_17 n_auto_17 Pnom M=1 L=1.8e-06 W=4e-06
R5 n_auto_17 n_auto_13  R=1.03e+06
M6 n_auto_13 n_auto_18 Vdd Vdd Pnom M=1 L=1.8e-06 W=6e-06
...
"""
        ...
        target_str = """M0 Iout1 n_auto_23 n_auto_22 n_auto_22 Nnom M=1 L=1e-06 W=2e-06
V1 n_auto_23 0  DC 1.7
M2 n_auto_22 Vin1 n_auto_21 n_auto_21 Pnom M=1 L=1.8e-06 W=4e-06
Rwire3 n_auto_21 n_auto_20  R=0
M4 n_auto_22 n_auto_24 gnd gnd Nnom M=1 L=1.8e-06 W=6e-06
V5 n_auto_24 0  DC 1.74
M6 Iout2 n_auto_27 n_auto_26 n_auto_26 Nnom M=1 L=1e-06 W=2e-06
V7 n_auto_27 0  DC 1.7
M8 n_auto_26 Vin2 n_auto_25 n_auto_25 Pnom M=1 L=1.8e-06 W=4e-06
Rwire9 n_auto_25 n_auto_20  R=0
M10 n_auto_26 n_auto_28 gnd gnd Nnom M=1 L=1.8e-06 W=6e-06
V11 n_auto_28 0  DC 1.74
M12 n_auto_20 n_auto_29 Vdd Vdd Pnom M=1 L=1.8e-06 W=6e-06
...
"""
        ...
        target_str = """M0 Iout1 n_auto_33 n_auto_32 n_auto_32 Pnom M=1 L=1e-06 W=2e-06
V1 n_auto_33 0  DC 0.1
M2 n_auto_32 Vin1 n_auto_31 n_auto_31 Nnom M=1 L=1.8e-06 W=4e-06
Rwire3 n_auto_31 n_auto_30  R=0
M4 n_auto_32 n_auto_34 Vdd Vdd Pnom M=1 L=1.8e-06 W=6e-06
V5 n_auto_34 0  DC 0.06
M6 Iout2 n_auto_37 n_auto_36 n_auto_36 Pnom M=1 L=1e-06 W=2e-06
V7 n_auto_37 0  DC 0.1
M8 n_auto_36 Vin2 n_auto_35 n_auto_35 Nnom M=1 L=1.8e-06 W=4e-06
Rwire9 n_auto_35 n_auto_30  R=0
M10 n_auto_36 n_auto_38 Vdd Vdd Pnom M=1 L=1.8e-06 W=6e-06
V11 n_auto_38 0  DC 0.06
M12 n_auto_30 n_auto_39 gnd gnd Nnom M=1 L=1.8e-06 W=6e-06
...
"""
    ...
    def _indexed_testDsViAmp1_TargetStr(self, index):
        if index==0:
            return """M0 n_auto_14 n_auto_19 n_auto_18 n_auto_18 Pnom M=1 L=1e-06 W=2e-06
V1 n_auto_19 0  DC 0.1
M2 n_auto_18 Vin1 n_auto_17 n_auto_17 Nnom M=1 L=1.8e-06 W=4e-06
Rwire3 n_auto_17 n_auto_16  R=0
M4 n_auto_18 n_auto_20 Vdd Vdd Pnom M=1 L=1.8e-06 W=6e-06
V5 n_auto_20 0  DC 0.06
M6 n_auto_15 n_auto_23 n_auto_22 n_auto_22 Pnom M=1 L=1e-06 W=2e-06
V7 n_auto_23 0  DC 0.1
M8 n_auto_22 Vin2 n_auto_21 n_auto_21 Nnom M=1 L=1.8e-06 W=4e-06
Rwire9 n_auto_21 n_auto_16  R=0
M10 n_auto_22 n_auto_24 Vdd Vdd Pnom M=1 L=1.8e-06 W=6e-06
V11 n_auto_24 0  DC 0.06
M12 n_auto_16 n_auto_25 gnd gnd Nnom M=1 L=1.8e-06 W=6e-06
V13 n_auto_25 0  DC 1.74
M14 n_auto_14 n_auto_14 gnd gnd Nnom M=1 L=9e-07 W=5.4e-07
M15 n_auto_15 n_auto_14 gnd gnd Nnom M=1 L=9e-07 W=1.08e-06
Rwire16 n_auto_15 Iout  R=0
"""
        elif index==1:
            return """Rwire0 n_auto_26 n_auto_29  R=0
M1 n_auto_29 Vin1 n_auto_30 n_auto_30 Pnom M=1 L=1.8e-06 W=4e-06
Rwire2 n_auto_30 n_auto_28  R=0
Rwire3 n_auto_27 n_auto_31  R=0
M4 n_auto_31 Vin2 n_auto_32 n_auto_32 Pnom M=1 L=1.8e-06 W=4e-06
Rwire5 n_auto_32 n_auto_28  R=0
M6 n_auto_28 n_auto_33 Vdd Vdd Pnom M=1 L=1.8e-06 W=6e-06
V7 n_auto_33 0  DC 0.06
M8 n_auto_26 n_auto_26 gnd gnd Nnom M=1 L=9e-07 W=5.4e-07
M9 n_auto_27 n_auto_26 gnd gnd Nnom M=1 L=9e-07 W=1.08e-06
Rwire10 n_auto_27 Iout  R=0
"""
        elif index==2:
            return """M0 n_auto_34 n_auto_39 n_auto_38 n_auto_38 Nnom M=1 L=1e-06 W=2e-06
V1 n_auto_39 0  DC 1.7
M2 n_auto_38 Vin1 n_auto_37 n_auto_37 Pnom M=1 L=1.8e-06 W=4e-06
Rwire3 n_auto_37 n_auto_36  R=0
M4 n_auto_38 n_auto_40 gnd gnd Nnom M=1 L=1.8e-06 W=6e-06
V5 n_auto_40 0  DC 1.74
M6 n_auto_35 n_auto_43 n_auto_42 n_auto_42 Nnom M=1 L=1e-06 W=2e-06
V7 n_auto_43 0  DC 1.7
M8 n_auto_42 Vin2 n_auto_41 n_auto_41 Pnom M=1 L=1.8e-06 W=4e-06
Rwire9 n_auto_41 n_auto_36  R=0
M10 n_auto_42 n_auto_44 gnd gnd Nnom M=1 L=1.8e-06 W=6e-06
V11 n_auto_44 0  DC 1.74
M12 n_auto_36 n_auto_45 Vdd Vdd Pnom M=1 L=1.8e-06 W=6e-06
V13 n_auto_45 0  DC 0.06
M14 n_auto_34 n_auto_34 Vdd Vdd Pnom M=1 L=9e-07 W=5.4e-07
M15 n_auto_35 n_auto_34 Vdd Vdd Pnom M=1 L=9e-07 W=1.08e-06
Rwire16 n_auto_35 Iout  R=0
"""      
        elif index==3:
            return """Rwire0 n_auto_46 n_auto_49  R=0
M1 n_auto_49 Vin1 n_auto_50 n_auto_50 Nnom M=1 L=1.8e-06 W=4e-06
Rwire2 n_auto_50 n_auto_48  R=0
Rwire3 n_auto_47 n_auto_51  R=0
M4 n_auto_51 Vin2 n_auto_52 n_auto_52 Nnom M=1 L=1.8e-06 W=4e-06
Rwire5 n_auto_52 n_auto_48  R=0
M6 n_auto_48 n_auto_53 gnd gnd Nnom M=1 L=1.8e-06 W=6e-06
V7 n_auto_53 0  DC 1.74
M8 n_auto_46 n_auto_46 Vdd Vdd Pnom M=1 L=9e-07 W=5.4e-07
M9 n_auto_47 n_auto_46 Vdd Vdd Pnom M=1 L=9e-07 W=1.08e-06
...
M0 n_auto_61 n_auto_66 n_auto_65 n_auto_65 Nnom M=1 L=7.2e-07 W=5.4e-07
...
"""
    ...
    def _compareStrings3(self, target_str, actual_str):
        ...
        """
        self._compareStrings2(replaceAfterMRWithBlank(target_str),
                              replaceAfterMRWithBlank(actual_str))
