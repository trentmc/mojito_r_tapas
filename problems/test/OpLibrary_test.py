...
class OpLibraryTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.lib = OpLibrary(OpLibraryStrategy(DEVICES_SETUP))
...
"""
    ...
    def testResistor(self):
        ...
        instance = EmbeddedPart(part, {'1':'a', '2':'b'}, {'V':1.0,'I':0.001})
        self.assertTrue( len(str(part)) > 0 )
        self.assertTrue( len(str(instance)) > 0 )
    ...
    def testMos4(self):
        ...
        target_str0 = """M0 1 2 3 4 Nnom M=5 L=1e-06 W=4.83382e-06
"""
        ...
        target_str0 = """M0 1 2 3 4 Pnom M=22 L=1e-06 W=4.84575e-06
"""
        actual_str0 = instance0.spiceNetlistStr()
        self._compareStrings(target_str0, actual_str0)
    ...
    def testMos3(self):
        ...
        target_str = """M0 1 2 3 3 Pnom M=22 L=1e-06 W=4.84575e-06
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings(target_str, actual_str)
    ...
    def testMosDiode(self):
        ...
        target_str = """M0 1 1 2 2 Pnom M=22 L=1e-06 W=4.84575e-06
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings(target_str, actual_str)
...
"""
    ...
    def testTwoBiasedMoses(self):
        ...
        target_str = """M0 1 XXX XXX XXX Nnom M=14 L=1e-06 W=4.85742e-06
V1 XXX 0  DC 1.3
M2 XXX XXX gnd gnd Nnom M=28 L=2e-06 W=4.85742e-06
V3 XXX 0  DC 0.7
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings2(target_str, actual_str)
        ...
        target_str = """M0 1 XXX XXX XXX Pnom M=22 L=1e-06 W=4.84575e-06
V1 XXX 0  DC 0.3
M2 XXX XXX Vdd Vdd Pnom M=22 L=1e-06 W=4.84575e-06
V3 XXX 0  DC 0.8
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings2(target_str, actual_str)   
    ...
    def testStackedCascodeMos(self):
        ...
        target_str = """M0 1 XXX 2 2 Nnom M=28 L=2e-06 W=4.85742e-06
V1 XXX 0  DC 0.7
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings2(target_str, actual_str)
        ...
        target_str = """M0 1 XXX XXX XXX Nnom M=14 L=1e-06 W=4.85742e-06
V1 XXX 0  DC 1.3
M2 XXX XXX 2 2 Nnom M=28 L=2e-06 W=4.85742e-06
V3 XXX 0  DC 0.7
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings2(target_str, actual_str)
...
"""
    ...
    def testLevelShifter(self):
        ...
        target_str = """M0 Vdd Vin Vout Vout Nnom M=14 L=1e-06 W=4.85742e-06
M1 Vout XXX gnd gnd Nnom M=5 L=1e-06 W=4.83382e-06
V2 XXX 0  DC 1
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings2(target_str, actual_str)
        ...
        target_str = """M0 Vdd Vin Vout Vout Nnom M=14 L=1e-06 W=4.85742e-06
M1 Vout XXX XXX XXX Nnom M=5 L=1e-06 W=4.83382e-06
V2 XXX 0  DC 1.35
M3 XXX XXX gnd gnd Nnom M=5 L=1e-06 W=4.83382e-06
V4 XXX 0  DC 1
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings2(target_str, actual_str)
        ...
        target_str = """M0 gnd Vin Vout Vout Pnom M=44 L=1e-06 W=4.914e-06
M1 Vout XXX Vdd Vdd Pnom M=22 L=1e-06 W=4.84575e-06
V2 XXX 0  DC 0.8
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings2(target_str, actual_str)
        ...
        target_str = """M0 gnd Vin Vout Vout Pnom M=44 L=1e-06 W=4.914e-06
M1 Vout XXX XXX XXX Pnom M=22 L=1e-06 W=4.84575e-06
V2 XXX 0  DC 0.45
M3 XXX XXX Vdd Vdd Pnom M=22 L=1e-06 W=4.84575e-06
V4 XXX 0  DC 0.8
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings2(target_str, actual_str)
...
"""
    ...
    def testViFeedback_LevelShifter(self):
        ...
        target_str = """M0 Vdd Vsensepos n_auto_176 n_auto_176 Nnom M=1 L=5.4e-07 W=5.4e-07
M1 n_auto_176 n_auto_177 gnd gnd Nnom M=1 L=9e-07 W=9e-07
...
"""
        ...
        target_str = """M0 Vdd VsensePos n_auto_178 n_auto_178 Nnom M=1 L=5.4e-07 W=5.4e-07
M1 n_auto_178 n_auto_179 gnd gnd Nnom M=1 L=9e-07 W=9e-07
...
"""
    ...
    def testInputCascode_Stacked(self):
        ...
        point = self._stackedPoint(input_is_pmos=False, degen_choice=1)
        instance = EmbeddedPart(part, conn, point)
        target_str = self._stackedNetlist(input_is_pmos=False, degen_choice=1)
        actual_str = instance.spiceNetlistStr()
        ...
        point = self._stackedPoint(input_is_pmos=True, degen_choice=1)
        instance = EmbeddedPart(part, conn, point)
        target_str = self._stackedNetlist(input_is_pmos=True, degen_choice=1)
        actual_str = instance.spiceNetlistStr()
        #log.info(instance.spiceNetlistStr(True, True))
        self._compareStrings3(target_str, actual_str)
        ...
        #Remember: input_is_pmos=False means loadrail_is_Vdd=True; and vice-versa
        conn = {'Vin':'Vin', 'Iout':'Iout', 'loadrail':'Vdd','opprail':'gnd'}
        point = self._stackedPoint(input_is_pmos=False, degen_choice=0)
        instance = EmbeddedPart(part, conn, point)
        target_str = self._stackedNetlist(input_is_pmos=False, degen_choice=0)
        actual_str = instance.spiceNetlistStr()
        #log.info(instance.spiceNetlistStr(True, True))
        self._compareStrings3(target_str, actual_str)
        ...
        #'pmos (upside-down) version':
        conn = {'Vin':'Vin', 'Iout':'Iout', 'loadrail':'gnd','opprail':'Vdd'}
        point = self._stackedPoint(input_is_pmos=True, degen_choice=0)
        instance = EmbeddedPart(part, conn, point)
        target_str = self._stackedNetlist(input_is_pmos=True, degen_choice=0)
        actual_str = instance.spiceNetlistStr()
        #log.info(instance.spiceNetlistStr(True, True))
        self._compareStrings3(target_str, actual_str)

    def _stackedPoint(self, input_is_pmos, degen_choice = 1):
        ...
        if input_is_pmos==0:
            return { 'input_is_pmos':0,
                 ...
                 'ampmos_Vgs':1.0,'ampmos_L':1e-6,'fracAmp':0.8,
                                  
                 'degen_choice':degen_choice,'fracDeg':0.1
                 }        
        else:
    ...
    def _stackedNetlist(self, input_is_pmos, degen_choice = 1):
        """For testing testInputCascode_Stacked"""
        if input_is_pmos and degen_choice:
            #all transistors should be pmos
            return """M0 Iout n_auto_18 n_auto_16 n_auto_16 Pnom M=22 L=1e-06 W=4.84575e-06
V1 n_auto_18 0  DC 0.3
M2 n_auto_16 Vin n_auto_17 n_auto_17 Pnom M=22 L=1e-06 W=4.84575e-06
R3 n_auto_17 Vdd  R=80
"""
        elif not input_is_pmos and degen_choice:
            #all transistors should be nmos
            return """Rwire0 Iout XXX  R=0
M1 XXX Vin XXX XXX Nnom
R2 XXX gnd  R=100
"""
        elif input_is_pmos and not degen_choice:
            #all transistors should be pmos
            return """M0 Iout XXX XXX XXX Pnom
V1 XXX 0  DC 0.3
M2 XXX Vin XXX XXX Pnom
Rwire3 XXX Vdd  R=0
"""
        elif not input_is_pmos and not degen_choice:
            #all transistors should be nmos
            return """Rwire0 Iout XXX  R=0
M1 XXX Vin XXX XXX Nnom
Rwire2 XXX gnd  R=0
"""
    ...
    def testInputCascode_Folded(self):
        ...
        conn = {'Vin':'Vin', 'Iout':'Iout', 'loadrail':'Vdd','opprail':'gnd'}
        point = self._foldedPoint(input_is_pmos=True,degen_choice=1)
        instance = EmbeddedPart(part, conn, point)
        target_str = self._foldedNetlist(input_is_pmos=True,degen_choice=1)
        actual_str = instance.spiceNetlistStr()
        #log.info(instance.spiceNetlistStr(True, True))
        self._compareStrings3(target_str, actual_str)
        ...
        conn = {'Vin':'Vin', 'Iout':'Iout', 'loadrail':'gnd','opprail':'Vdd'}
        point = self._foldedPoint(input_is_pmos=False,degen_choice=1)
        instance = EmbeddedPart(part, conn, point)
        target_str = self._foldedNetlist(input_is_pmos=False,degen_choice=1)
        actual_str = instance.spiceNetlistStr()
        #log.info(instance.spiceNetlistStr(True, True))
        self._compareStrings3(target_str, actual_str)
        ...
        #instantiate with input_is_pmos=True, degen_choice of biasedMos (1)
        conn = {'Vin':'Vin', 'Iout':'Iout', 'loadrail':'Vdd','opprail':'gnd'}
        point = self._foldedPoint(input_is_pmos=True,degen_choice=0)
        instance = EmbeddedPart(part, conn, point)
        target_str = self._foldedNetlist(input_is_pmos=True,degen_choice=0)
        actual_str = instance.spiceNetlistStr()
        #log.info(instance.spiceNetlistStr(True, True))
        self._compareStrings3(target_str, actual_str)
        ...
        #instantiate with input_is_pmos=False
        conn = {'Vin':'Vin', 'Iout':'Iout', 'loadrail':'gnd','opprail':'Vdd'}
        point = self._foldedPoint(input_is_pmos=False,degen_choice=0)
        instance = EmbeddedPart(part, conn, point)
        target_str = self._foldedNetlist(input_is_pmos=False,degen_choice=0)
        actual_str = instance.spiceNetlistStr()
        #log.info(instance.spiceNetlistStr(True, True))
        self._compareStrings3(target_str, actual_str)

    def _foldedPoint(self, input_is_pmos, degen_choice):
        ...
        if input_is_pmos == 0 and degen_choice == 0:
            point['cascode_is_wire']=1
        return point     
    
    def _foldedNetlist(self, input_is_pmos,degen_choice=1):
        """For testing testInputCascode_Folded"""
        if input_is_pmos and degen_choice:
            return """M0 Iout XXX XXX XXX Nnom M=6 L=4e-07 W=7.31838e-06
V1 XXX 0  DC 1.06
M2 XXX Vin XXX XXX Pnom M=8 L=4e-07 W=9.01629e-06
R3 XXX Vdd  R=144
M4 XXX XXX gnd gnd Nnom M=5 L=4e-07 W=6.40656e-06
V5 XXX 0  DC 1
"""
        elif not input_is_pmos and degen_choice:
            return """M0 Iout XXX XXX XXX Pnom M=13 L=4e-07 W=2.088e-05
V1 XXX 0  DC 0.74
M2 XXX Vin XXX XXX Nnom M=4 L=4e-07 W=3.1583e-06
R3 XXX gnd  R=144
M4 XXX XXX Vdd Vdd Pnom M=10 L=4e-07 W=1.74496e-05
V5 XXX 0  DC 0.8
"""
        elif input_is_pmos and not degen_choice:
            return """M0 Iout XXX XXX XXX Nnom M=6 L=4e-07 W=7.31838e-06
V1 XXX 0  DC 1.06
M2 XXX Vin XXX XXX Pnom M=8 L=4e-07 W=8.94076e-06
Rwire3 XXX Vdd  R=0
M4 XXX XXX gnd gnd Nnom M=5 L=4e-07 W=6.40656e-06
V5 XXX 0  DC 1
"""
            ...
            return """Rwire0 Iout XXX R=0
M1 XXX Vin XXX XXX Nnom M=4 L=4e-07 W=3.24231e-06
Rwire2 XXX gnd  R=0
M3 XXX XXX Vdd Vdd Pnom M=10 L=4e-07 W=1.37015e-05
V4 XXX 0  DC 0.8
"""
    ...
    def testSsIiLoad_Cascoded(self):
        ...
        target_str = """M0 n_auto_85 n_auto_86 Vdd Vdd Pnom M=22 L=1e-06 W=4.84575e-06
V1 n_auto_86 0  DC 0.8
M2 Iout n_auto_87 n_auto_85 n_auto_85 Pnom M=22 L=1e-06 W=4.84575e-06
...
"""
        ...
        target_str = """M0 n_auto_88 n_auto_89 gnd gnd Nnom M=5 L=1e-06 W=4.83382e-06
V1 n_auto_89 0  DC 1
M2 Iout n_auto_90 n_auto_88 n_auto_88 Nnom M=5 L=1e-06 W=4.83382e-06
...
"""
        ...
        target_str = """M0 gnd n_auto_88 Iout Iout Nnom M=5 L=1e-06 W=4.83382e-06
V1 n_auto_88 0  DC 1
"""
        actual_str = instance.spiceNetlistStr()
...
M1 n_auto_103 Vin n_auto_104 n_auto_104 Nnom M=5 L=1e-06 W=4.83382e-06
...
M1 XXX Vin XXX XXX Nnom M=31 L=1.8e-07 W=4.94358e-06
Rwire2 XXX gnd  R=0
R3 Vdd Iout  R=%g
...
"""
    ...
    def testCurrentMirror_Simple(self):
        ...
        target_str = """M0 Irefnode Irefnode gnd gnd Nnom M=5 L=1e-06 W=4.83382e-06
M1 Ioutnode Irefnode gnd gnd Nnom M=5 L=1e-06 W=4.83382e-06
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings3(target_str, actual_str)
        ...
        target_str = """M0 Irefnode Irefnode Vdd Vdd Pnom M=22 L=1e-06 W=4.84575e-06
M1 Ioutnode Irefnode Vdd Vdd Pnom M=22 L=1e-06 W=4.84575e-06
"""
        actual_str = instance.spiceNetlistStr()
    ...
    def testCurrentMirror_Cascode(self):
        ...
        target_str = """M0 Irefnode Irefnode n_auto_12 n_auto_12 Nnom M=27 L=1e-06 W=4.87053e-06
M1 n_auto_12 n_auto_12 gnd gnd Nnom M=27 L=1e-06 W=4.87053e-06
M2 Ioutnode Irefnode n_auto_13 n_auto_13 Nnom M=27 L=1e-06 W=4.87053e-06
M3 n_auto_13 n_auto_12 gnd gnd Nnom M=27 L=1e-06 W=4.87053e-06
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings3(target_str, actual_str)
        ...
        target_str = """M0 Irefnode Irefnode n_auto_14 n_auto_14 Pnom M=87 L=2e-06 W=4.97049e-06
M1 n_auto_14 n_auto_14 Vdd Vdd Pnom M=44 L=1e-06 W=4.914e-06
M2 Ioutnode Irefnode n_auto_15 n_auto_15 Pnom M=87 L=2e-06 W=4.97049e-06
M3 n_auto_15 n_auto_14 Vdd Vdd Pnom M=44 L=1e-06 W=4.914e-06
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings3(target_str, actual_str)
    ...
    def testCurrentMirror_LowVoltageA(self):
        ...
        target_str = """M0 Irefnode n_auto_21 n_auto_19 n_auto_19 Nnom M=5 L=1e-06 W=4.83382e-06
V1 n_auto_21 0  DC 1.6
M2 n_auto_19 Irefnode gnd gnd Nnom M=4 L=1e-06 W=4.0708e-06
M3 Ioutnode n_auto_22 n_auto_20 n_auto_20 Nnom M=5 L=1e-06 W=4.83382e-06
V4 n_auto_22 0  DC 1.5
M5 n_auto_20 Irefnode gnd gnd Nnom M=4 L=1e-06 W=4.0708e-06
"""
        actual_str = instance.spiceNetlistStr()
        self._compareStrings3(target_str, actual_str)
    ...
    def _verifyCmChoice(self, chosen_part_index, target_name):
        ...
        if (chosen_part_index==0):
            target_str = """M0 Irefnode Irefnode gnd gnd Nnom M=4 L=1e-06 W=4.0708e-06
M1 Ioutnode Irefnode gnd gnd Nnom M=4 L=1e-06 W=4.0708e-06
"""
...
"""
    ...
    def testDsIiLoad(self):
        ...
        target_str = """M0 Iin1 Iin1 gnd gnd Nnom M=4 L=1e-06 W=4.0708e-06
M1 Iin2 Iin1 gnd gnd Nnom M=4 L=1e-06 W=4.0708e-06
...
"""
    ...
    def testDdViInput(self):
        ...
        target_str = """M0 Iout1 n_auto_44 n_auto_42 n_auto_42 Nnom M=5 L=1e-06 W=4.83382e-06
V1 n_auto_44 0  DC 1.68
M2 n_auto_42 Vin1 n_auto_43 n_auto_43 Nnom M=5 L=1e-06 W=4.83382e-06
Rwire3 n_auto_43 n_auto_41  R=0
M4 Iout2 n_auto_47 n_auto_45 n_auto_45 Nnom M=5 L=1e-06 W=4.83382e-06
V5 n_auto_47 0  DC 1.68
M6 n_auto_45 Vin2 n_auto_46 n_auto_46 Nnom M=5 L=1e-06 W=4.83382e-06
Rwire7 n_auto_46 n_auto_41  R=0
M8 n_auto_41 n_auto_48 gnd gnd Nnom M=10 L=1e-06 W=4.83382e-06
V9 n_auto_48 0  DC 1
"""
        ...
        target_str = """M0 Iout1 n_auto_50 n_auto_48 n_auto_48 Pnom M=22 L=1e-06 W=4.84575e-06
V1 n_auto_50 0  DC 0.12
M2 n_auto_48 Vin1 n_auto_49 n_auto_49 Pnom M=22 L=1e-06 W=4.84575e-06
Rwire3 n_auto_49 n_auto_47  R=0
M4 Iout2 n_auto_53 n_auto_51 n_auto_51 Pnom M=22 L=1e-06 W=4.84575e-06
V5 n_auto_53 0  DC 0.12
M6 n_auto_51 Vin2 n_auto_52 n_auto_52 Pnom M=22 L=1e-06 W=4.84575e-06
Rwire7 n_auto_52 n_auto_47  R=0
M8 n_auto_47 n_auto_54 Vdd Vdd Pnom M=43 L=1e-06 W=4.95845e-06
...
"""
        ...
        target_str = """M0 Iout1 n_auto_60 n_auto_59 n_auto_59 Pnom M=22 L=1e-06 W=4.84575e-06
V1 n_auto_60 0  DC 0.08
M2 n_auto_59 Vin1 n_auto_58 n_auto_58 Nnom M=5 L=1e-06 W=4.83382e-06
Rwire3 n_auto_58 n_auto_57  R=0
M4 n_auto_59 n_auto_61 Vdd Vdd Pnom M=43 L=1e-06 W=4.95845e-06
V5 n_auto_61 0  DC 0.8
M6 Iout2 n_auto_64 n_auto_63 n_auto_63 Pnom M=22 L=1e-06 W=4.84575e-06
V7 n_auto_64 0  DC 0.08
M8 n_auto_63 Vin2 n_auto_62 n_auto_62 Nnom M=5 L=1e-06 W=4.83382e-06
Rwire9 n_auto_62 n_auto_57  R=0
M10 n_auto_63 n_auto_65 Vdd Vdd Pnom M=43 L=1e-06 W=4.95845e-06
V11 n_auto_65 0  DC 0.8
M12 n_auto_57 n_auto_66 gnd gnd Nnom M=10 L=1e-06 W=4.83382e-06
...
"""
        ...
        target_str = """M0 Iout1 n_auto_70 n_auto_69 n_auto_69 Nnom M=5 L=1e-06 W=4.83382e-06
V1 n_auto_70 0  DC 1.72
M2 n_auto_69 Vin1 n_auto_68 n_auto_68 Pnom M=22 L=1e-06 W=4.84575e-06
Rwire3 n_auto_68 n_auto_67  R=0
M4 n_auto_69 n_auto_71 gnd gnd Nnom M=10 L=1e-06 W=4.83382e-06
V5 n_auto_71 0  DC 1
M6 Iout2 n_auto_74 n_auto_73 n_auto_73 Nnom M=5 L=1e-06 W=4.83382e-06
V7 n_auto_74 0  DC 1.72
M8 n_auto_73 Vin2 n_auto_72 n_auto_72 Pnom M=22 L=1e-06 W=4.84575e-06
Rwire9 n_auto_72 n_auto_67  R=0
M10 n_auto_73 n_auto_75 gnd gnd Nnom M=10 L=1e-06 W=4.83382e-06
V11 n_auto_75 0  DC 1
M12 n_auto_67 n_auto_76 Vdd Vdd Pnom M=43 L=1e-06 W=4.95845e-06
...
#                  'Vds_internal':abs(1.8*(input_is_pmos==1)-1.0),
    ...
    def _indexed_testDsViAmp1_TargetStr(self, index):
        if index==0:
            return """M0 n_auto_95 n_auto_100 n_auto_99 n_auto_99 Pnom M=22 L=1e-06 W=4.84575e-06
V1 n_auto_100 0  DC 0.08
M2 n_auto_99 Vin1 n_auto_98 n_auto_98 Nnom M=5 L=1e-06 W=4.83382e-06
Rwire3 n_auto_98 n_auto_97  R=0
M4 n_auto_99 n_auto_101 Vdd Vdd Pnom M=43 L=1e-06 W=4.95845e-06
V5 n_auto_101 0  DC 0.8
M6 n_auto_96 n_auto_104 n_auto_103 n_auto_103 Pnom M=22 L=1e-06 W=4.84575e-06
V7 n_auto_104 0  DC 0.08
M8 n_auto_103 Vin2 n_auto_102 n_auto_102 Nnom M=5 L=1e-06 W=4.83382e-06
Rwire9 n_auto_102 n_auto_97  R=0
M10 n_auto_103 n_auto_105 Vdd Vdd Pnom M=43 L=1e-06 W=4.95845e-06
V11 n_auto_105 0  DC 0.8
M12 n_auto_97 n_auto_106 gnd gnd Nnom M=10 L=1e-06 W=4.83382e-06
V13 n_auto_106 0  DC 1
M14 n_auto_95 n_auto_95 gnd gnd Nnom M=5 L=1e-06 W=4.83382e-06
M15 n_auto_96 n_auto_95 gnd gnd Nnom M=5 L=1e-06 W=4.83382e-06
Rwire16 n_auto_96 Iout  R=0
"""
        elif index==1:
            return """M0 n_auto_95 n_auto_100 n_auto_98 n_auto_98 Pnom M=22 L=1e-06 W=4.84575e-06
V1 n_auto_100 0  DC 0.2
M2 n_auto_98 Vin1 n_auto_99 n_auto_99 Pnom M=22 L=1e-06 W=4.84575e-06
Rwire3 n_auto_99 n_auto_97  R=0
M4 n_auto_96 n_auto_103 n_auto_101 n_auto_101 Pnom M=22 L=1e-06 W=4.84575e-06
V5 n_auto_103 0  DC 0.2
M6 n_auto_101 Vin2 n_auto_102 n_auto_102 Pnom M=22 L=1e-06 W=4.84575e-06
Rwire7 n_auto_102 n_auto_97  R=0
M8 n_auto_97 n_auto_104 Vdd Vdd Pnom M=43 L=1e-06 W=4.95845e-06
V9 n_auto_104 0  DC 0.8
M10 n_auto_95 n_auto_95 gnd gnd Nnom M=5 L=1e-06 W=4.83382e-06
M11 n_auto_96 n_auto_95 gnd gnd Nnom M=5 L=1e-06 W=4.83382e-06
Rwire12 n_auto_96 Iout  R=0
"""
        elif index==2:
            return """M0 n_auto_120 n_auto_125 n_auto_124 n_auto_124 Nnom M=5 L=1e-06 W=4.83382e-06
V1 n_auto_125 0  DC 1.72
M2 n_auto_124 Vin1 n_auto_123 n_auto_123 Pnom M=22 L=1e-06 W=4.84575e-06
Rwire3 n_auto_123 n_auto_122  R=0
M4 n_auto_124 n_auto_126 gnd gnd Nnom M=10 L=1e-06 W=4.83382e-06
V5 n_auto_126 0  DC 1
M6 n_auto_121 n_auto_129 n_auto_128 n_auto_128 Nnom M=5 L=1e-06 W=4.83382e-06
V7 n_auto_129 0  DC 1.72
M8 n_auto_128 Vin2 n_auto_127 n_auto_127 Pnom M=22 L=1e-06 W=4.84575e-06
Rwire9 n_auto_127 n_auto_122  R=0
M10 n_auto_128 n_auto_130 gnd gnd Nnom M=10 L=1e-06 W=4.83382e-06
V11 n_auto_130 0  DC 1
M12 n_auto_122 n_auto_131 Vdd Vdd Pnom M=43 L=1e-06 W=4.95845e-06
V13 n_auto_131 0  DC 0.8
M14 n_auto_120 n_auto_120 Vdd Vdd Pnom M=44 L=1e-06 W=4.914e-06
M15 n_auto_121 n_auto_120 Vdd Vdd Pnom M=44 L=1e-06 W=4.914e-06
Rwire16 n_auto_121 Iout  R=0
"""      
        elif index==3:
            return """M0 n_auto_95 n_auto_100 n_auto_98 n_auto_98 Nnom M=5 L=1e-06 W=4.83382e-06
V1 n_auto_100 0  DC 1.6
M2 n_auto_98 Vin1 n_auto_99 n_auto_99 Nnom M=5 L=1e-06 W=4.83382e-06
Rwire3 n_auto_99 n_auto_97  R=0
M4 n_auto_96 n_auto_103 n_auto_101 n_auto_101 Nnom M=5 L=1e-06 W=4.83382e-06
V5 n_auto_103 0  DC 1.6
M6 n_auto_101 Vin2 n_auto_102 n_auto_102 Nnom M=5 L=1e-06 W=4.83382e-06
Rwire7 n_auto_102 n_auto_97  R=0
M8 n_auto_97 n_auto_104 gnd gnd Nnom M=10 L=1e-06 W=4.83382e-06
V9 n_auto_104 0  DC 1
M10 n_auto_95 n_auto_95 Vdd Vdd Pnom M=44 L=1e-06 W=4.914e-06
M11 n_auto_96 n_auto_95 Vdd Vdd Pnom M=44 L=1e-06 W=4.914e-06
Rwire12 n_auto_96 Iout  R=0
"""
...
"""
            ...
            return """M0 n_auto_120 n_auto_125 n_auto_123 n_auto_123 Pnom M=22 L=1e-06 W=4.84575e-06
V1 n_auto_125 0  DC 0.26
M2 n_auto_123 Vin1 n_auto_124 n_auto_124 Pnom M=22 L=1e-06 W=4.84575e-06
Rwire3 n_auto_124 n_auto_122  R=0
M4 n_auto_121 n_auto_128 n_auto_126 n_auto_126 Pnom M=22 L=1e-06 W=4.84575e-06
V5 n_auto_128 0  DC 0.26
M6 n_auto_126 Vin2 n_auto_127 n_auto_127 Pnom M=22 L=1e-06 W=4.84575e-06
Rwire7 n_auto_127 n_auto_122  R=0
M8 n_auto_122 n_auto_129 Vdd Vdd Pnom M=43 L=1e-06 W=4.95845e-06
V9 n_auto_129 0  DC 0.8
M10 n_auto_120 n_auto_120 gnd gnd Nnom M=5 L=1e-06 W=4.83382e-06
M11 n_auto_121 n_auto_120 gnd gnd Nnom M=5 L=1e-06 W=4.83382e-06
Rwire12 n_auto_121 Iout  R=0
"""
        elif index==2:
            return """M0 n_auto_143 n_auto_148 n_auto_147 n_auto_147 Nnom M=5 L=1e-06 W=4.83382e-06
V1 n_auto_148 0  DC 1.72
M2 n_auto_147 Vin1 n_auto_146 n_auto_146 Pnom M=22 L=1e-06 W=4.84575e-06
Rwire3 n_auto_146 n_auto_145  R=0
M4 n_auto_147 n_auto_149 gnd gnd Nnom M=10 L=1e-06 W=4.83382e-06
V5 n_auto_149 0  DC 1
M6 n_auto_144 n_auto_152 n_auto_151 n_auto_151 Nnom M=5 L=1e-06 W=4.83382e-06
V7 n_auto_152 0  DC 1.72
M8 n_auto_151 Vin2 n_auto_150 n_auto_150 Pnom M=22 L=1e-06 W=4.84575e-06
Rwire9 n_auto_150 n_auto_145  R=0
M10 n_auto_151 n_auto_153 gnd gnd Nnom M=10 L=1e-06 W=4.83382e-06
V11 n_auto_153 0  DC 1
M12 n_auto_145 n_auto_154 Vdd Vdd Pnom M=43 L=1e-06 W=4.95845e-06
V13 n_auto_154 0  DC 0.8
M14 n_auto_143 n_auto_143 Vdd Vdd Pnom M=44 L=1e-06 W=4.914e-06
M15 n_auto_144 n_auto_143 Vdd Vdd Pnom M=44 L=1e-06 W=4.914e-06
Rwire16 n_auto_144 Iout  R=0
"""      
        elif index==3:
            return """M0 n_auto_168 n_auto_173 n_auto_171 n_auto_171 Nnom M=5 L=1e-06 W=4.83382e-06
V1 n_auto_173 0  DC 1.54
M2 n_auto_171 Vin1 n_auto_172 n_auto_172 Nnom M=5 L=1e-06 W=4.83382e-06
Rwire3 n_auto_172 n_auto_170  R=0
M4 n_auto_169 n_auto_176 n_auto_174 n_auto_174 Nnom M=5 L=1e-06 W=4.83382e-06
V5 n_auto_176 0  DC 1.54
M6 n_auto_174 Vin2 n_auto_175 n_auto_175 Nnom M=5 L=1e-06 W=4.83382e-06
Rwire7 n_auto_175 n_auto_170  R=0
M8 n_auto_170 n_auto_177 gnd gnd Nnom M=10 L=1e-06 W=4.83382e-06
V9 n_auto_177 0  DC 1
M10 n_auto_168 n_auto_168 Vdd Vdd Pnom M=44 L=1e-06 W=4.914e-06
M11 n_auto_169 n_auto_168 Vdd Vdd Pnom M=44 L=1e-06 W=4.914e-06
...
"""
    ...
    def testDdViAmp1(self):
        ...
        target_str = """M0 Iout1 n_auto_14 n_auto_12 n_auto_12 Nnom M=1 L=7.2e-07 W=5.4e-07
V1 n_auto_14 0  DC 1.7
M2 n_auto_12 Vin1 n_auto_13 n_auto_13 Nnom M=1 L=1.08e-06 W=9e-07
R3 n_auto_13 n_auto_11  R=1.03e+06
M4 Iout2 n_auto_17 n_auto_15 n_auto_15 Nnom M=1 L=7.2e-07 W=5.4e-07
V5 n_auto_17 0  DC 1.7
M6 n_auto_15 Vin2 n_auto_16 n_auto_16 Nnom M=1 L=1.08e-06 W=9e-07
R7 n_auto_16 n_auto_11  R=1.03e+06
M8 n_auto_11 n_auto_18 gnd gnd Nnom M=1 L=1.62e-06 W=1.62e-06
...
M1 n_auto_29 Vin1 n_auto_30 n_auto_30 Nnom M=1 L=1.08e-06 W=9e-07
Rwire2 n_auto_30 n_auto_28  R=0
Rwire3 n_auto_27 n_auto_31  R=0
M4 n_auto_31 Vin2 n_auto_32 n_auto_32 Nnom M=1 L=1.08e-06 W=9e-07
Rwire5 n_auto_32 n_auto_28  R=0
M6 n_auto_28 n_auto_33 gnd gnd Nnom M=1 L=1.62e-06 W=1.62e-06
V7 n_auto_33 0  DC 1.74
M8 n_auto_26 n_auto_26 Vdd Vdd Pnom M=1 L=7.2e-07 W=1.08e-06
M9 n_auto_27 n_auto_26 Vdd Vdd Pnom M=1 L=7.2e-07 W=2.16e-06
Rwire10 n_auto_27 n_auto_24  R=0
Rwire11 Iout n_auto_34  R=0
M12 n_auto_34 n_auto_25 n_auto_35 n_auto_35 Nnom M=1 L=3e-06 W=4e-06
...
Rwire10 n_auto_27 n_auto_24  R=0
Rwire11 Iout n_auto_34  R=0
M12 n_auto_34 n_auto_25 n_auto_35 n_auto_35 Pnom M=2 L=3e-06 W=4e-06
...
"""
    ...
    def testMillerAmp_2(self):
        ...
        target_str = """M0 n_auto_61 n_auto_66 n_auto_65 n_auto_65 Nnom M=1 L=7.2e-07 W=5.4e-07
V1 n_auto_66 0  DC 1.7
M2 n_auto_65 Vin1 n_auto_64 n_auto_64 Pnom M=1 L=1.08e-06 W=1.8e-06
Rwire3 n_auto_64 n_auto_63  R=0
M4 n_auto_65 n_auto_67 gnd gnd Nnom M=1 L=1.62e-06 W=1.62e-06
V5 n_auto_67 0  DC 1.74
M6 n_auto_62 n_auto_70 n_auto_69 n_auto_69 Nnom M=1 L=7.2e-07 W=5.4e-07
V7 n_auto_70 0  DC 1.7
M8 n_auto_69 Vin2 n_auto_68 n_auto_68 Pnom M=1 L=1.08e-06 W=1.8e-06
Rwire9 n_auto_68 n_auto_63  R=0
M10 n_auto_69 n_auto_71 gnd gnd Nnom M=1 L=1.62e-06 W=1.62e-06
V11 n_auto_71 0  DC 1.74
M12 n_auto_63 n_auto_72 Vdd Vdd Pnom M=1 L=1.62e-06 W=3.24e-06
V13 n_auto_72 0  DC 0.06
M14 n_auto_61 n_auto_61 Vdd Vdd Pnom M=1 L=7.2e-07 W=1.08e-06
M15 n_auto_62 n_auto_61 Vdd Vdd Pnom M=1 L=7.2e-07 W=2.16e-06
Rwire16 n_auto_62 n_auto_59  R=0
M17 Iout n_auto_75 n_auto_74 n_auto_74 Nnom M=1 L=7.2e-07 W=5.4e-07
V18 n_auto_75 0  DC 1.7
M19 n_auto_74 n_auto_60 n_auto_73 n_auto_73 Pnom M=2 L=3e-06 W=4e-06
Rwire20 n_auto_73 Vdd  R=0
M21 n_auto_74 n_auto_76 gnd gnd Nnom M=2 L=5e-06 W=3e-06
...
M1 n_auto_116 Vin1 n_auto_117 n_auto_117 Nnom M=1 L=3e-06 W=4e-06
Rwire2 n_auto_117 n_auto_115  R=0
Rwire3 n_auto_114 n_auto_118  R=0
M4 n_auto_118 Vin2 n_auto_119 n_auto_119 Nnom M=1 L=3e-06 W=4e-06
Rwire5 n_auto_119 n_auto_115  R=0
M6 n_auto_115 n_auto_120 gnd gnd Nnom M=2 L=5e-06 W=3e-06
V7 n_auto_120 0  DC 1.74
M8 n_auto_113 n_auto_113 Vdd Vdd Pnom M=1 L=9e-07 W=1.08e-06
M9 n_auto_114 n_auto_113 Vdd Vdd Pnom M=1 L=9e-07 W=2.16e-06
Rwire10 n_auto_114 n_auto_111  R=0
Rwire11 Iout n_auto_121  R=0
M12 n_auto_121 n_auto_112 n_auto_122 n_auto_122 Pnom M=1 L=1.08e-06 W=1.8e-06
Rwire13 n_auto_122 Vdd  R=0
R14 gnd Iout  R=10000
M15 Vdd n_auto_111 n_auto_112 n_auto_112 Nnom M=1 L=5.4e-07 W=5.4e-07
M16 n_auto_112 n_auto_123 gnd gnd Nnom M=1 L=9e-07 W=9e-07
...
"""
    ...
    def _compareStrings3(self, target_str, actual_str):
        ...
        after the M= (for transistors) and after the R= (for resistors)
        ...
        """
        target_str = replaceAfterMRWithBlank(target_str)
        target_str= self.cleanLineWhitespace(target_str)
        
        actual_str = replaceAfterMRWithBlank(actual_str)
        actual_str= self.cleanLineWhitespace(actual_str)
