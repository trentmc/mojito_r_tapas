...
class LibraryTest(unittest.TestCase):
    ...
    def test_replaceAfterMRWithBlank(self):
        if self.just1: return
        #
...
"""
        self.assertEqual(replaceAfterMRWithBlank(target_str), without_str)
...
R3 n_auto_15 gnd  
"""
        self.assertEqual(replaceAfterMRWithBlank(input_str), without_str)
